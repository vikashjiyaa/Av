...
TOKEN = '7385947182:AAFuq-SRh1M1BSemhVUDcfkNsinX3sb8MGU'
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/DARKCHEATSBGMI/88*", parse_mode='Markdown')
        ...
        bot.reply_to(message, '''*@Bgmi_owner_420
        *''', parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin selected ADMIN -: @Bgmi_owner_420*", parse_mode='Markdown')
    else:
